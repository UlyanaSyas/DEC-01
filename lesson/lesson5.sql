...
/*
   13. Отображение фамилии, ЗП, должности всех сотрудников, кто в продажах (sales representative, stock clerk),
...
WHERE
    e.job_id = j.job_id 
    AND j.job_title IN ('Sales Кepresentative', 'Stock Сlerk')
